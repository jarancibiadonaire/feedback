			...
			<div class="col-md-4 md-margin-bottom-40">
				...
				<div class="posts">
					...
					<dl class="dl-horizontal">
						<dt>
							<a href="#"><img
								src="<c:url value="/resources/assets/img/sliders/elastislide/6.jpg"/>"
								alt="" /></a>
						</dt>
						<dd>
							<p>
					...
					<dl class="dl-horizontal">
						<dt>
							<a href="#"><img
								src="<c:url value="/resources/assets/img/sliders/elastislide/10.jpg"/>"
								alt="" /></a>
						</dt>
						<dd>
							<p>
					...
					<dl class="dl-horizontal">
						<dt>
							<a href="#"><img
								src="<c:url value="/resources/assets/img/sliders/elastislide/11.jpg"/>"
								alt="" /></a>
						</dt>
						<dd>
							<p>
